            ...
            <div class="container">
                  <div class="row">
                      <div class="col-lg-9 col-lg-push-3">
                        ...
                        <h2>Привет тут ты сможешь узнать больше обо мне, моих хобби, моих сделанный работах, да и вообще о жизни в целом!  Так же, если тебе стало скучно, ты всегда сможешь открыть игру и немного отдохнуть ) </h2>
                        <img class="btn1" src="image/gallery/arrow.png" alt="">
                        <a href="game.html"><img class="btn1" src="image/gallery/game.png" alt=""></a>
                      </div>
