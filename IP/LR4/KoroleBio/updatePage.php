  ...
  <body>
    ...
    <div class="container-fluid">
      ...
      <div class="wrapper">
        ...
        <label>ФИО</label>
        <p><input type="text" name="full_name"value="<?= $product['full_name']?>"></p>
        <label>Логин</label>
        <p><input type="text" name="login" value="<?= $product['login']?>"></p>
        <label>Почта</label>
        <p><input type="email" name="email" value="<?= $product['email']?>"></p>
        <label>Пароль</label>
        <p><input type="password" name="password" value="<?= $product['password']?>"></p>
